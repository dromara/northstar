...
public class CThostFtdcReqApiHandshakeField {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        jctpv6v3v15x64apiJNI.delete_CThostFtdcReqApiHandshakeField(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setCryptoKeyVersion(String value) {
    jctpv6v3v15x64apiJNI.CThostFtdcReqApiHandshakeField_CryptoKeyVersion_set(swigCPtr, this, value);
  }

  public String getCryptoKeyVersion() {
    return jctpv6v3v15x64apiJNI.CThostFtdcReqApiHandshakeField_CryptoKeyVersion_get(swigCPtr, this);
  }

  public CThostFtdcReqApiHandshakeField() {
    this(jctpv6v3v15x64apiJNI.new_CThostFtdcReqApiHandshakeField(), true);
  }
