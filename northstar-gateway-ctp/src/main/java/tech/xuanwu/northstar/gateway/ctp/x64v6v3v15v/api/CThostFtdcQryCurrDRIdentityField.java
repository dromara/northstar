...
public class CThostFtdcQryCurrDRIdentityField {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        jctpv6v3v15x64apiJNI.delete_CThostFtdcQryCurrDRIdentityField(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setDRIdentityID(int value) {
    jctpv6v3v15x64apiJNI.CThostFtdcQryCurrDRIdentityField_DRIdentityID_set(swigCPtr, this, value);
  }

  public int getDRIdentityID() {
    return jctpv6v3v15x64apiJNI.CThostFtdcQryCurrDRIdentityField_DRIdentityID_get(swigCPtr, this);
  }

  public CThostFtdcQryCurrDRIdentityField() {
    this(jctpv6v3v15x64apiJNI.new_CThostFtdcQryCurrDRIdentityField(), true);
  }
