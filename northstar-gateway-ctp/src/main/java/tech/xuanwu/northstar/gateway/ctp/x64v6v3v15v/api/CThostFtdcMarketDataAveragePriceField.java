...
public class CThostFtdcMarketDataAveragePriceField {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        jctpv6v3v15x64apiJNI.delete_CThostFtdcMarketDataAveragePriceField(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setAveragePrice(double value) {
    jctpv6v3v15x64apiJNI.CThostFtdcMarketDataAveragePriceField_AveragePrice_set(swigCPtr, this, value);
  }

  public double getAveragePrice() {
    return jctpv6v3v15x64apiJNI.CThostFtdcMarketDataAveragePriceField_AveragePrice_get(swigCPtr, this);
  }

  public CThostFtdcMarketDataAveragePriceField() {
    this(jctpv6v3v15x64apiJNI.new_CThostFtdcMarketDataAveragePriceField(), true);
  }
