...
public class CThostFtdcCurrDRIdentityField {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        jctpv6v5v1cpx64apiJNI.delete_CThostFtdcCurrDRIdentityField(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setDRIdentityID(int value) {
    jctpv6v5v1cpx64apiJNI.CThostFtdcCurrDRIdentityField_DRIdentityID_set(swigCPtr, this, value);
  }

  public int getDRIdentityID() {
    return jctpv6v5v1cpx64apiJNI.CThostFtdcCurrDRIdentityField_DRIdentityID_get(swigCPtr, this);
  }

  public CThostFtdcCurrDRIdentityField() {
    this(jctpv6v5v1cpx64apiJNI.new_CThostFtdcCurrDRIdentityField(), true);
  }
