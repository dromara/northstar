...
public class CtpTradeNowFactory extends AbstractGatewayFactory{

private FastEventEngine fastEventEngine;
	
	public CtpTradeNowFactory(FastEventEngine fastEventEngine) {
	...
	public Gateway newInstance(GatewayDescription gatewayDescription) {
		...
		CtpApiSettingField ctpSetting = CtpApiSettingField.newBuilder()
				...
				.build();
		return new CtpGatewayTradeNowAdapter(fastEventEngine, GatewaySettingField.newBuilder()
