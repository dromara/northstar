	...
	static {
		...
		try {
			...
			if (System.getProperties().getProperty("os.name").toUpperCase().indexOf("WINDOWS") != -1) {
				...
				copyURLToFileForTmp(tempLibPath, CtpGatewayAdapter.class.getResource("/tradenow/jctpv6v3v15x64api/libthostmduserapi_se.so"));
				copyURLToFileForTmp(tempLibPath, CtpGatewayAdapter.class.getResource("/tradenow/jctpv6v3v15x64api/libthosttraderapi_se.so"));
				copyURLToFileForTmp(tempLibPath, CtpGatewayAdapter.class.getResource("/tradenow/jctpv6v3v15x64api/libjctpv6v3v15x64api.so"));
			}
		} catch (Exception e) {
