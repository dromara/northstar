...
public class CThostFtdcQueryFreqField {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        jctpv6v5v1cpx64apiJNI.delete_CThostFtdcQueryFreqField(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setQueryFreq(int value) {
    jctpv6v5v1cpx64apiJNI.CThostFtdcQueryFreqField_QueryFreq_set(swigCPtr, this, value);
  }

  public int getQueryFreq() {
    return jctpv6v5v1cpx64apiJNI.CThostFtdcQueryFreqField_QueryFreq_get(swigCPtr, this);
  }

  public CThostFtdcQueryFreqField() {
    this(jctpv6v5v1cpx64apiJNI.new_CThostFtdcQueryFreqField(), true);
  }
