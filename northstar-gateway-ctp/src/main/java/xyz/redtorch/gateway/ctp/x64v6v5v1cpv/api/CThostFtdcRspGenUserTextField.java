...
public class CThostFtdcRspGenUserTextField {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        jctpv6v5v1cpx64apiJNI.delete_CThostFtdcRspGenUserTextField(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setUserTextSeq(int value) {
    jctpv6v5v1cpx64apiJNI.CThostFtdcRspGenUserTextField_UserTextSeq_set(swigCPtr, this, value);
  }

  public int getUserTextSeq() {
    return jctpv6v5v1cpx64apiJNI.CThostFtdcRspGenUserTextField_UserTextSeq_get(swigCPtr, this);
  }

  public CThostFtdcRspGenUserTextField() {
    this(jctpv6v5v1cpx64apiJNI.new_CThostFtdcRspGenUserTextField(), true);
  }
