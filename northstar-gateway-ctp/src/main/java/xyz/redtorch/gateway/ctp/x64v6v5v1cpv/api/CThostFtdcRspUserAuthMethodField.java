...
public class CThostFtdcRspUserAuthMethodField {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        jctpv6v5v1cpx64apiJNI.delete_CThostFtdcRspUserAuthMethodField(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setUsableAuthMethod(int value) {
    jctpv6v5v1cpx64apiJNI.CThostFtdcRspUserAuthMethodField_UsableAuthMethod_set(swigCPtr, this, value);
  }

  public int getUsableAuthMethod() {
    return jctpv6v5v1cpx64apiJNI.CThostFtdcRspUserAuthMethodField_UsableAuthMethod_get(swigCPtr, this);
  }

  public CThostFtdcRspUserAuthMethodField() {
    this(jctpv6v5v1cpx64apiJNI.new_CThostFtdcRspUserAuthMethodField(), true);
  }
