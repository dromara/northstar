...
public class CtpConstant {
	...
	static {
		...
		// 持仓类型映射
		posiDirectionMap.put(PositionDirectionEnum.PD_Net, jctpv6v5v1cpx64apiConstants.THOST_FTDC_PD_Net);
		posiDirectionMap.put(PositionDirectionEnum.PD_Long, jctpv6v5v1cpx64apiConstants.THOST_FTDC_PD_Long);
		posiDirectionMap.put(PositionDirectionEnum.PD_Short, jctpv6v5v1cpx64apiConstants.THOST_FTDC_PD_Short);
