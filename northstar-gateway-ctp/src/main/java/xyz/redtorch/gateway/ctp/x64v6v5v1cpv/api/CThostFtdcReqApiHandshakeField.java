...
public class CThostFtdcReqApiHandshakeField {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        jctpv6v5v1cpx64apiJNI.delete_CThostFtdcReqApiHandshakeField(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setCryptoKeyVersion(String value) {
    jctpv6v5v1cpx64apiJNI.CThostFtdcReqApiHandshakeField_CryptoKeyVersion_set(swigCPtr, this, value);
  }

  public String getCryptoKeyVersion() {
    return jctpv6v5v1cpx64apiJNI.CThostFtdcReqApiHandshakeField_CryptoKeyVersion_get(swigCPtr, this);
  }

  public CThostFtdcReqApiHandshakeField() {
    this(jctpv6v5v1cpx64apiJNI.new_CThostFtdcReqApiHandshakeField(), true);
  }
