...
class ClosingPolicyTest {
    ...
    void testFirstInFirstOutCloseToday() {
        ...
        OffsetFlagEnum result = ClosingPolicy.FIRST_IN_FIRST_OUT.resolveOffsetFlag(SignalOperation.BUY_CLOSE, contract, nonclosedTrades, tradingDay);
    ...
    void testFirstInFirstOutClose() {
        ...
        OffsetFlagEnum result = ClosingPolicy.FIRST_IN_FIRST_OUT.resolveOffsetFlag(SignalOperation.SELL_CLOSE, contract, List.of(trade1), tradingDay);
        assertEquals(OffsetFlagEnum.OF_Close, result);
        
        OffsetFlagEnum result2 = ClosingPolicy.FIRST_IN_FIRST_OUT.resolveOffsetFlag(SignalOperation.SELL_CLOSE, contract, List.of(trade1, trade2), tradingDay);
    ...
    void testFirstInLastOutCloseToday() {
        ...
        OffsetFlagEnum result = ClosingPolicy.FIRST_IN_LAST_OUT.resolveOffsetFlag(SignalOperation.BUY_CLOSE, contract, List.of(trade2), tradingDay);
        assertEquals(OffsetFlagEnum.OF_CloseToday, result);
        
        OffsetFlagEnum result2 = ClosingPolicy.FIRST_IN_LAST_OUT.resolveOffsetFlag(SignalOperation.BUY_CLOSE, contract, List.of(trade1, trade2), tradingDay);
    ...
    void testFirstInLastOutClose() {
        ...
        OffsetFlagEnum result = ClosingPolicy.FIRST_IN_LAST_OUT.resolveOffsetFlag(SignalOperation.SELL_CLOSE, contract, nonclosedTrades, tradingDay);
        assertEquals(OffsetFlagEnum.OF_Close, result);
    }
    ...
    void testCloseNonTodayHedgeTodayOpen() {
        ...
        OffsetFlagEnum result2 = ClosingPolicy.CLOSE_NONTODAY_HEGDE_TODAY.resolveOffsetFlag(SignalOperation.SELL_CLOSE, contract, List.of(trade2), tradingDay);
    ...
    void testCloseNonTodayHedgeTodayClose() {
        ...
        OffsetFlagEnum result = ClosingPolicy.CLOSE_NONTODAY_HEGDE_TODAY.resolveOffsetFlag(SignalOperation.SELL_CLOSE, contract, List.of(trade1), tradingDay);
        assertEquals(OffsetFlagEnum.OF_Close, result);
        
        OffsetFlagEnum result2 = ClosingPolicy.CLOSE_NONTODAY_HEGDE_TODAY.resolveOffsetFlag(SignalOperation.SELL_CLOSE, contract, List.of(trade1, trade2), tradingDay);
        assertEquals(OffsetFlagEnum.OF_Close, result2);
    }
