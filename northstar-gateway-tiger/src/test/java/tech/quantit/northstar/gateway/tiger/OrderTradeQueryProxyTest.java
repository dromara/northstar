...
class OrderTradeQueryProxyTest {
	...
	void testGetDeltaTrade() {
		...
		when(client.execute(any(TigerHttpRequest.class))).thenReturn(response);
		when(response.isSuccess()).thenReturn(true);
		when(response.getData()).thenReturn("{\"items\":[{\"id\":29530667114823680,\"accountId\":20221212084743666,\"orderId\":29530665135767552,\"secType\":\"STK\",\"symbol\":\"01810\",\"right\":\"PUT\",\"currency\":\"HKD\",\"market\":\"HK\",\"action\":\"BUY\",\"filledQuantity\":200,\"filledPrice\":11.84,\"filledAmount\":2368.0,\"transactedAt\":\"2023-01-20 15:38:30\",\"transactionTime\":1674200310180}]}");
