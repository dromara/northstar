...
proto.xyz.redtorch.pb.GatewayField.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    autherrorflag: jspb.Message.getBooleanFieldWithDefault(msg, 7, false)
  };
...
/**
 * @param {string} value
 * @return {!proto.xyz.redtorch.pb.GatewayField} returns this
 */
...
proto.xyz.redtorch.pb.ContractField.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    multiplier: jspb.Message.getFloatingPointFieldWithDefault(msg, 12, 0.0),
    pricetick: jspb.Message.getFloatingPointFieldWithDefault(msg, 13, 0.0),
    longmarginratio: jspb.Message.getFloatingPointFieldWithDefault(msg, 14, 0.0),
    shortmarginratio: jspb.Message.getFloatingPointFieldWithDefault(msg, 15, 0.0),
    maxmarginsidealgorithm: jspb.Message.getBooleanFieldWithDefault(msg, 16, false),
    underlyingsymbol: jspb.Message.getFieldWithDefault(msg, 17, ""),
    strikeprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 18, 0.0),
    optionstype: jspb.Message.getFieldWithDefault(msg, 19, 0),
    underlyingmultiplier: jspb.Message.getFloatingPointFieldWithDefault(msg, 20, 0.0),
...
proto.xyz.redtorch.pb.AccountField.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    prebalance: jspb.Message.getFloatingPointFieldWithDefault(msg, 6, 0.0),
    balance: jspb.Message.getFloatingPointFieldWithDefault(msg, 7, 0.0),
    available: jspb.Message.getFloatingPointFieldWithDefault(msg, 8, 0.0),
    commission: jspb.Message.getFloatingPointFieldWithDefault(msg, 9, 0.0),
    margin: jspb.Message.getFloatingPointFieldWithDefault(msg, 10, 0.0),
    closeprofit: jspb.Message.getFloatingPointFieldWithDefault(msg, 11, 0.0),
    positionprofit: jspb.Message.getFloatingPointFieldWithDefault(msg, 12, 0.0),
    deposit: jspb.Message.getFloatingPointFieldWithDefault(msg, 13, 0.0),
    withdraw: jspb.Message.getFloatingPointFieldWithDefault(msg, 14, 0.0),
...
/**
 * @param {string} value
 * @return {!proto.xyz.redtorch.pb.AccountField} returns this
 */
...
proto.xyz.redtorch.pb.OrderField.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    price: jspb.Message.getFloatingPointFieldWithDefault(msg, 14, 0.0),
    ...
    stopprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 22, 0.0),
...
/**
 * @param {string} value
 * @return {!proto.xyz.redtorch.pb.OrderField} returns this
 */
...
/**
 * @param {string} value
 * @return {!proto.xyz.redtorch.pb.TradeField} returns this
 */
...
proto.xyz.redtorch.pb.PositionField.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lastprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 10, 0.0),
    price: jspb.Message.getFloatingPointFieldWithDefault(msg, 11, 0.0),
    pricediff: jspb.Message.getFloatingPointFieldWithDefault(msg, 12, 0.0),
    openprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 13, 0.0),
    openpricediff: jspb.Message.getFloatingPointFieldWithDefault(msg, 14, 0.0),
    positionprofit: jspb.Message.getFloatingPointFieldWithDefault(msg, 15, 0.0),
    positionprofitratio: jspb.Message.getFloatingPointFieldWithDefault(msg, 16, 0.0),
    openpositionprofit: jspb.Message.getFloatingPointFieldWithDefault(msg, 17, 0.0),
    openpositionprofitratio: jspb.Message.getFloatingPointFieldWithDefault(msg, 18, 0.0),
    usemargin: jspb.Message.getFloatingPointFieldWithDefault(msg, 19, 0.0),
    exchangemargin: jspb.Message.getFloatingPointFieldWithDefault(msg, 20, 0.0),
    contractvalue: jspb.Message.getFloatingPointFieldWithDefault(msg, 21, 0.0),
...
/**
 * @param {string} value
 * @return {!proto.xyz.redtorch.pb.PositionField} returns this
 */
...
proto.xyz.redtorch.pb.TickField.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lastprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 8, 0.0),
    avgprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 9, 0.0),
    totalbidvol: jspb.Message.getFieldWithDefault(msg, 10, 0),
    totalaskvol: jspb.Message.getFieldWithDefault(msg, 11, 0),
    weightedavgbidprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 12, 0.0),
    weightedavgaskprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 13, 0.0),
    iopv: jspb.Message.getFloatingPointFieldWithDefault(msg, 14, 0.0),
    yieldtomaturity: jspb.Message.getFloatingPointFieldWithDefault(msg, 15, 0.0),
    ...
    turnoverdelta: jspb.Message.getFloatingPointFieldWithDefault(msg, 19, 0.0),
    numtrades: jspb.Message.getFieldWithDefault(msg, 20, 0),
    numtradesdelta: jspb.Message.getFieldWithDefault(msg, 21, 0),
    openinterest: jspb.Message.getFloatingPointFieldWithDefault(msg, 22, 0.0),
    openinterestdelta: jspb.Message.getFloatingPointFieldWithDefault(msg, 23, 0.0),
    preopeninterest: jspb.Message.getFloatingPointFieldWithDefault(msg, 24, 0.0),
    precloseprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 25, 0.0),
    settleprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 26, 0.0),
    presettleprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 27, 0.0),
    openprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 28, 0.0),
    highprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 29, 0.0),
    lowprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 30, 0.0),
    upperlimit: jspb.Message.getFloatingPointFieldWithDefault(msg, 31, 0.0),
    lowerlimit: jspb.Message.getFloatingPointFieldWithDefault(msg, 32, 0.0),
    ...
    channeltype: jspb.Message.getFieldWithDefault(msg, 37, "")
  };
 ...
 * @return {string}
 */
proto.xyz.redtorch.pb.TickField.prototype.getChanneltype = function() {
 ...
 * @return {!proto.xyz.redtorch.pb.TickField} returns this
 */
proto.xyz.redtorch.pb.TickField.prototype.setChanneltype = function(value) {
...
proto.xyz.redtorch.pb.BarField.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    closeprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 10, 0.0),
    openinterest: jspb.Message.getFloatingPointFieldWithDefault(msg, 11, 0.0),
    openinterestdelta: jspb.Message.getFloatingPointFieldWithDefault(msg, 12, 0.0),
    ...
    turnoverdelta: jspb.Message.getFloatingPointFieldWithDefault(msg, 16, 0.0),
    ...
    channeltype: jspb.Message.getFieldWithDefault(msg, 22, "")
  };
 ...
 * @return {string}
 */
proto.xyz.redtorch.pb.BarField.prototype.getChanneltype = function() {
 ...
 * @return {!proto.xyz.redtorch.pb.BarField} returns this
 */
proto.xyz.redtorch.pb.BarField.prototype.setChanneltype = function(value) {
...
/**
 * @param {string} value
 * @return {!proto.xyz.redtorch.pb.CommonReqField} returns this
 */
...
/**
 * @param {string} value
 * @return {!proto.xyz.redtorch.pb.CommonRspField} returns this
 */
...
proto.xyz.redtorch.pb.SubmitOrderReqField.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    stopprice: jspb.Message.getFloatingPointFieldWithDefault(msg, 17, 0.0),
    ...
    actiontimestamp: jspb.Message.getFieldWithDefault(msg, 22, 0)
  };
...
/**
 * @param {string} value
 * @return {!proto.xyz.redtorch.pb.SubmitOrderReqField} returns this
 */
 ...
 * @return {number}
 */
proto.xyz.redtorch.pb.SubmitOrderReqField.prototype.getActiontimestamp = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 22, 0));
};
 ...
 * @return {!proto.xyz.redtorch.pb.SubmitOrderReqField} returns this
 */
proto.xyz.redtorch.pb.SubmitOrderReqField.prototype.setActiontimestamp = function(value) {
  return jspb.Message.setProto3IntField(this, 22, value);
};
...
/**
 * @param {string} value
 * @return {!proto.xyz.redtorch.pb.CancelOrderReqField} returns this
 */
...
/**
 * @param {string} value
 * @return {!proto.xyz.redtorch.pb.GatewaySettingField.CtpApiSettingField} returns this
 */
...
/**
 * @param {string} value
 * @return {!proto.xyz.redtorch.pb.GatewaySettingField.IbApiSettingField} returns this
 */
...
/**
 * @param {string} value
 * @return {!proto.xyz.redtorch.pb.GatewaySettingField} returns this
 */
...
proto.xyz.redtorch.pb.GatewaySettingField.prototype.clearCtpapisetting = function() {
  return this.setCtpapisetting(undefined);
};
...
proto.xyz.redtorch.pb.GatewaySettingField.prototype.clearIbapisetting = function() {
  return this.setIbapisetting(undefined);
};
 ...
 * @return {!proto.xyz.redtorch.pb.LogField} returns this
 */
