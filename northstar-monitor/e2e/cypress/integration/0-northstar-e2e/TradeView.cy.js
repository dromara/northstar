...
describe('回放测试——期货合约', () => {
    before(() => {
        ...
        cy.get('.el-dialog').filter(':visible').contains('回放合约').parent().find('.el-select').click()
        cy.get('.el-select-dropdown').filter(':visible').contains('螺纹钢指数').click()
...
describe('回放测试——股票合约', () => {
    before(() => {
        ...
        cy.get('.el-select-dropdown').filter(':visible').contains('正常').click()
        cy.get('.el-dialog').filter(':visible').contains('回放合约').parent().find('.el-select').click()
        cy.get('.el-select-dropdown').filter(':visible').contains('格力电器').click()
        cy.get('.el-dialog').filter(':visible').contains("保 存").click()
        cy.wait(300)
        cy.get('.el-dialog').filter(':visible').contains("保 存").click()
        cy.wait(300)
